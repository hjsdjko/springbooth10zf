...
public class DiscusswaiguomeishiController {
    ...
    public R info(@PathVariable("id") Long id){
        DiscusswaiguomeishiEntity discusswaiguomeishi = discusswaiguomeishiService.selectById(id);
        return R.ok().put("data", discusswaiguomeishi);
    }
    ...
    public R save(@RequestBody DiscusswaiguomeishiEntity discusswaiguomeishi, HttpServletRequest request){
        ...
        discusswaiguomeishiService.insert(discusswaiguomeishi);
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        discusswaiguomeishiService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		int count = discusswaiguomeishiService.selectCount(wrapper);
